...
if 0:
    ...
    presentation_times = [0.2, 0.08, 0.06]
...
for pt in presentation_times:
    energy = flops0 + (flopjoules_synop*synops + flopjoules_update*updates) * pt
    print("pt %d ms: flops = %0.2e, energy = %0.2e, efficiency = %0.2f" % (
        1000*pt, flops, energy, (flops / energy)))
